...
pub use session::{
    ...
    is_project_docs_autodump, normalize_session_path, Agent, DerivationType, ExecStatus,
    MessageRole, PatchFile, PatchOp, PlanItem, PlanItemStatus, RuntimeMetrics, Session,
